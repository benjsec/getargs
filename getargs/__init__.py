                    ...
                    if self.longest() > 1:
                        ...
                        if let:
                            ...
                            if self.type(let) == type(None):
                                ...
                                print "Long argument can't do autoincrementing; keyword %s, type %s" % (
                                    let,
                                    self.type(let),
                                )
                            # -----------Integer---------------------------------------------------------------------------
                                ...
                                if i and isnumber(i):
                                    ...
                                    print "Missing value for keyword %s, type %s" % (
                                        let,
                                        self.type(let),
                                    )
                            # -----------Long------------------------------------------------------------------------------
                                ...
                                # -----------Integer---------------------------------------------------------------------------
                                    ...
                                    if len(rs) > 0:
                                        ...
                                        if i and isnumber(i):
                                            ...
                                            print "Missing value for keyletter %s, type %s" % (
                                                c,
                                                self.type(c),
                                            )
